...
xlabel('\sigma')
ylabel('\mu')
title('VaR constraint (\alpha=0.3, \tau=0.7)')
...
xlabel('\sigma')
ylabel('\mu')
title('CVaR constraint (\alpha=0.3, \tau=0.7)')
h.Ticks=[30,50:20:170,200]
h.TickLabels={'30','50','70','90','110','130','150','170','Infeasible'}
...
xlabel('\sigma')
ylabel('\mu')
title('VaR constraint (\alpha=0.2, \tau=0.8)')
h.Ticks=[30,50:20:150]
h.TickLabels={'30','50','70','90','110','130','Infeasible'}
...
xlabel('\sigma')
ylabel('\mu')
title('CVaR constraint (\alpha=0.2, \tau=0.8)')
